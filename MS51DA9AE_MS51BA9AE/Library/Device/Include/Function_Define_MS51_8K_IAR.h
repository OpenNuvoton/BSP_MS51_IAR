...
/*                                                                        */
/*         All IP function define for Nuvoton MS51 8K Series              */
/*------------------------------------------------------------------------*/
/* Convert To IAR: extern   bit BIT_TMP; */
/******************************************************************************/
...
#define    ENABLE_PWM0_CH3_P04_OUTPUT      BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PIOCON1|=0x08;TA=0xAA;TA=0x55;SFRS=0;EA=BIT_TMP        //P0.4 as PWM3 output enable
#define    ENABLE_PWM0_CH3_P00_OUTPUT      PIOCON0|=0x08                                                //P0.0 as PWM3 
#define    ENABLE_PWM0_CH2_P05_OUTPUT      BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PIOCON1|=0x04;TA=0xAA;TA=0x55;SFRS=0;EA=BIT_TMP        //P1.0 as PWM2 output enable
...
#define    DISABLE_PWM0_CH3_P04_OUTPUT     BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PIOCON1&=0xF7;TA=0xAA;TA=0x55;SFRS=0;EA=BIT_TMP        //P0.4 as PWM3 output disable
#define    DISABLE_PWM0_CH3_P00_OUTPUT     PIOCON0&=0xF7                                                //P0.0 as PWM3 
#define    DISABLE_PWM0_CH2_P05_OUTPUT     BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PIOCON1&=0xFB;TA=0xAA;TA=0x55;SFRS=0;EA=BIT_TMP        //P1.0 as PWM2 output disable
...
#define    ENABLE_PWM0_FALLING_INT          BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PWMINTC&=0xCF;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define    ENABLE_PWM0_RISING_INT           BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PWMINTC&=0xCF;PWMINTC|=0x10;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define    ENABLE_PWM0_CENTRAL_POINT_INT    BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PWMINTC&=0xCF;PWMINTC|=0x20;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define    ENABLE_PWM0_PERIOD_END_INT       BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PWMINTC&=0xCF;PWMINTC|=0x30;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
//--------- PWM interrupt pin select ---------------------------*/
#define    ENABLE_PWM0_CH0_INT              BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PWMINTC&=0xF8;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define    ENABLE_PWM0_CH1_INT              BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PWMINTC&=0xF8;PWMINTC|=0x01;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define    ENABLE_PWM0_CH2_INT              BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PWMINTC&=0xF8;PWMINTC|=0x02;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define    ENABLE_PWM0_CH3_INT              BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PWMINTC&=0xF8;PWMINTC|=0x03;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define    ENABLE_PWM0_CH4_INT              BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PWMINTC&=0xF8;PWMINTC|=0x04;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define    ENABLE_PWM0_CH5_INT              BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;SFRS=1;PWMINTC&=0xF8;PWMINTC|=0x05;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
...
#define    DISABLE_PWM0_CH45_DEADTIME       BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;PDTEN&=0xFB;EA=BIT_TMP
#define    DISABLE_PWM0_CH23_DEADTIME       BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;PDTEN&=0xFD;EA=BIT_TMP
#define    DISABLE_PWM0_CH01_DEADTIME       BIT_TMP=EA;EA=0;TA=0xAA;TA=0x55;PDTEN&=0xFE;EA=BIT_TMP
...
#define    ENABLE_ADC_CH0                 ADCCON0&=0xF0;ADCCON0|=0x00;P17_INPUT_MODE;AINDIDS=0;AINDIDS|=0x01;ADCCON1|=0x01    //P17
#define    ENABLE_ADC_CH1                 ADCCON0&=0xF0;ADCCON0|=0x01;P30_INPUT_MODE;AINDIDS=0;AINDIDS|=0x02;ADCCON1|=0x01    //P30
#define    ENABLE_ADC_CH3                 ADCCON0&=0xF0;ADCCON0|=0x03;P06_INPUT_MODE;AINDIDS=0;AINDIDS|=0x08;ADCCON1|=0x01    //P06
#define    ENABLE_ADC_CH4                 ADCCON0&=0xF0;ADCCON0|=0x04;P05_INPUT_MODE;AINDIDS=0;AINDIDS|=0x10;ADCCON1|=0x01    //P05
#define    ENABLE_ADC_CH5                 ADCCON0&=0xF0;ADCCON0|=0x05;P04_INPUT_MODE;AINDIDS=0;AINDIDS|=0x20;ADCCON1|=0x01    //P04
#define    ENABLE_ADC_CH6                 ADCCON0&=0xF0;ADCCON0|=0x06;P03_INPUT_MODE;AINDIDS=0;AINDIDS|=0x40;ADCCON1|=0x01    //P03
#define    ENABLE_ADC_CH7                 ADCCON0&=0xF0;ADCCON0|=0x07;P11_INPUT_MODE;AINDIDS=0;AINDIDS|=0x80;ADCCON1|=0x01    //P11
#define    ENABLE_ADC_BANDGAP             ADCCON0&=0xF0;ADCCON0|=0x08;ADCCON1|=0x01                                           //Band-gap 1.22V
...
#define    P04_FALLINGEDGE_TRIG_ADC       ADCCON0&=0xCF;ADCCON0|=0x30;ADCCON1&=0xF3;ADCCON1|=0x00;ADCCON1|=0x02
#define    P04_RISINGEDGE_TRIG_ADC        ADCCON0&=0xCF;ADCCON0|=0x30;ADCCON1&=0xF3;ADCCON1|=0x04;ADCCON1|=0x02
