...
#define set_AUXR1_UART1PX   AUXR1|= 0x02
...
#define clr_AUXR1_UART1PX   AUXR1&= 0xFD
...
#define set_PIOCON1_PIO04    BIT_TMP=EA;TA=0xAA;TA=0x55;SFRS=0x01;PIOCON1|=0x08;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define set_PIOCON1_PIO05    BIT_TMP=EA;TA=0xAA;TA=0x55;SFRS=0x01;PIOCON1|=0x04;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define set_PIOCON1_PIO14    BIT_TMP=EA;TA=0xAA;TA=0x55;SFRS=0x01;PIOCON1|=0x02;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
            
#define clr_PIOCON1_PIO15    BIT_TMP=EA;TA=0xAA;TA=0x55;SFRS=0x01;PIOCON1&=0xDF;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define clr_PIOCON1_PIO04    BIT_TMP=EA;TA=0xAA;TA=0x55;SFRS=0x01;PIOCON1&=0xF7;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define clr_PIOCON1_PIO05    BIT_TMP=EA;TA=0xAA;TA=0x55;SFRS=0x01;PIOCON1&=0xFB;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define clr_PIOCON1_PIO14    BIT_TMP=EA;TA=0xAA;TA=0x55;SFRS=0x01;PIOCON1&=0xFD;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
...
//**** PIOCON0  DEH ****
#define set_PIOCON0_PIO03      PIOCON0|=0x20
#define set_PIOCON0_PIO01      PIOCON0|=0x10
#define set_PIOCON0_PIO00      PIOCON0|=0x08
#define set_PIOCON0_PIO10      PIOCON0|=0x04
#define set_PIOCON0_PIO11      PIOCON0|=0x02
#define set_PIOCON0_PIO12      PIOCON0|=0x01
                               
#define clr_PIOCON0_PIO03      PIOCON0&=0xDF
#define clr_PIOCON0_PIO01      PIOCON0&=0xEF
#define clr_PIOCON0_PIO00      PIOCON0&=0xF7
#define clr_PIOCON0_PIO10      PIOCON0&=0xFB
#define clr_PIOCON0_PIO11      PIOCON0&=0xFD
#define clr_PIOCON0_PIO12      PIOCON0&=0xFE
...
#define set_SPCR2_SPIS0        BIT_TMP=EA;TA=0xAA;TA=0x55;SFRS=0x00;SPCR2|=0x02;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
                              
#define clr_SPCR2_SPIS1        BIT_TMP=EA;TA=0xAA;TA=0x55;SFRS=0x00;SPCR2&=0xFD;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
#define clr_SPCR2_SPIS0        BIT_TMP=EA;TA=0xAA;TA=0x55;SFRS=0x00;SPCR2&=0xFE;TA=0xAA;TA=0x55;SFRS=0x00;EA=BIT_TMP
