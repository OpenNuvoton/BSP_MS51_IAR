...
#if 0
  __xdata volatile unsigned char uart_rcvbuf[64]; 
  __xdata volatile unsigned char uart_txbuf[64];
  __data volatile unsigned char bufhead;
  __data volatile unsigned int flash_address; 
  __data volatile unsigned int AP_size;
  __data volatile unsigned char g_timer1Counter;
  __data volatile unsigned char count; 
  __data volatile unsigned int g_timer0Counter;
  __data volatile unsigned long g_checksum;
  __data volatile unsigned long g_totalchecksum;
#endif
  
   __xdata  unsigned char uart_rcvbuf[64]; 
  __xdata  unsigned char uart_txbuf[64];
  __data  unsigned char bufhead;
  __data  unsigned int flash_address; 
  __data  unsigned int AP_size;
  __data  unsigned char g_timer1Counter;
  __data  unsigned char count; 
  __data  unsigned int g_timer0Counter;
  __data  unsigned long g_checksum;
  __data  unsigned long g_totalchecksum;
  unsigned char  bUartDataReady;
  unsigned char  g_timer0Over;
  unsigned char  g_timer1Over;
  unsigned char  g_programflag;
